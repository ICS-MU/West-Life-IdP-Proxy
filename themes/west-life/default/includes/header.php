...
?>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML_Module::getModuleUrl('west-life/res/bootstrap/css/bootstrap.min.css'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML_Module::getModuleUrl('west-life/res/css/west-life.css'); ?>" />
...
<div id="wrap">
	...
	<div id="header">
		<img src="<?php echo SimpleSAML_Module::getModuleUrl('west-life/res/img/logo_256.png'); ?>" alt="West-life logo">
		<h1><a class="header-link" href="/<?php echo $this->data['baseurlpath']; ?>">
		<?php 
			echo "Enter your WeNMR credentials";
		?>
		</a></h1>
	</div>
