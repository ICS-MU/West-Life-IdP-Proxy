...
$this->data['head'] .= '<script src="' . SimpleSAML_Module::getModuleUrl('west-life/res/js/jquery.js')  . '" ></script>';
$this->data['head'] .= '<script src="' . SimpleSAML_Module::getModuleUrl('west-life/res/bootstrap/js/bootstrap.min.js')  . '" ></script>';
