...
$this->data['head'] .= '<link rel="stylesheet" media="screen" type="text/css" href="' . SimpleSAML_Module::getModuleUrl('west-life/res/css/disco.css')  . '" />';
...
if ($this->isOriginalSpNonFilteringIdPs()) {
	echo 'Still can\'t find your institution? Contact us at <a href="mailto:westlife-aai@ics.muni.cz?subject=Request%20for%20adding%20new%20IdP">westlife-aai@ics.muni.cz</a>';
} else {
	echo 'Can\'t find your institution? Contact us at <a href="mailto:westlife-aai@ics.muni.cz?subject=Request%20for%20adding%20new%20IdP">westlife-aai@ics.muni.cz</a>';
}
echo '</div>';
